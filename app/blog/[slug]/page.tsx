    ...
    <article className="pb-24 pt-12">
      ...
      <header className="container mx-auto px-4 max-w-4xl text-center mb-12">
        <div className="mb-6 flex justify-center">
          <span className="bg-white text-black text-sm font-bold px-4 py-1.5 rounded-full border border-gray-200">
            {post.category.name}
          </span>
        </div>
      ...
      {/* Article Content */}
      <div className="container mx-auto px-4 max-w-3xl prose prose-lg prose-a:text-black">
