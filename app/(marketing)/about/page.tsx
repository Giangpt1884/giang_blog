  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <div className="bg-white rounded-3xl p-8 md:p-16">
        <span className="text-gray-500 font-bold uppercase tracking-wider text-sm mb-4 block text-center">
          Về Chúng Tôi
        </span>
        ...
        <div className="prose prose-lg prose-primary max-w-none text-gray-600">
          <p className="lead text-xl text-gray-700 font-medium mb-12 text-center">
            Dự án này được xây dựng để chia sẻ kiến thức, kinh nghiệm và trải nghiệm thực tế với cộng đồng.
          </p>
          ...
          <p>
            Với định hướng thiết kế UI tinh gọn, giao diện Responsive và trải nghiệm người dùng mượt mà, chúng tôi hy vọng Giangpt Blog sẽ trở thành bộ khung lý tưởng để các bạn mở rộng thêm nhiều dự án thực tế.
          </p>
        </div>

        <div className="mt-16 pt-12 border-t border-gray-100 flex justify-center">
          <Link href="/blog" className="h-12 px-8 text-base font-medium rounded-md bg-black text-white hover:bg-gray-800 transition-colors flex items-center justify-center">
            Khám phá Blog
          </Link>
        </div>
      </div>
